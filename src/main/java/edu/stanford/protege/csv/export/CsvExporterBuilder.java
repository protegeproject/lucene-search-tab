...
public class CsvExporterBuilder {
    ...
    public CsvExporterBuilder setDependentAnnotations(Map<OWLEntity, List<OWLEntity>> map) {
        this.dependentAnnotations = map;
        return this;
    }
    ...
    public CsvExporter build() {
        return new CsvExporter(editorKit, outputFile, output, properties, dependentAnnotations, fileDelimiter, propertyValuesDelimiter, includeHeaders, includeEntityTypes,
