...
public class SearchQueryTest {
    ...
    private static Set<OWLEntity> getQueryEvaluationResults(SearchTabQuery query) throws QueryEvaluationException {
        return query.evaluate(null, new AtomicBoolean(false));
    }
}
